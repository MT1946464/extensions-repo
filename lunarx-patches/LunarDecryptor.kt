...
/**
 * LunarX chapter payload implementation adapted from the unmerged upstream
 * keiyoushi/extensions-source PR #18429, which directly targeted
 * "Failed to find payload seeds" after Lunar's domain/payload migration.
 *
 * Kept as an explicit patch in this repository so the Tachimanga build is
 * reproducible and does not depend on a mutable external PR branch.
 */
